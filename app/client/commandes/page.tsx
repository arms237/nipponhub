    ...
    setFormData(prev => {
      if (name === "country") {
        return {
          ...prev,
          country: value,
          city: "" // Réinitialise la ville si le pays change
        };
      }
      return {
        ...prev,
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  const phoneNumber = formData.city === 'Douala' ?  '237658849218':'237686556967' ;
          ...
          <div className="bg-base-100 p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className='input inpur-bordered flex items-center gap-2'>
